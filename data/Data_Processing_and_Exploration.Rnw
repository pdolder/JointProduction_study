...
<<Setup, echo=FALSE, comment = F, warning = F, results = 'hide'>>=
...
<<LWt, echo = F, fig.cap = 'Estimates of individual weights at length for the gadoid species. Colours indicate individual years measurements', fig.width = 8, fig.height = 8>>=
...
<<LWt2, echo = F, fig.caption = 'Length and weight measurements on a log scale',fig.width = 8, fig.height = 8>>=
...
<<GLM fit, results = 'asis', comment = F>>=
...
<<Distance calcs, echo = F, message = F, fig.align = 'center'>>=
...
<<DoorSpread2, fig.width = 5, fig.height = 5, echo = F, fig.align = 'center',warning = F, comment = F>>=
...
<<Doorspread4, results = 'asis', echo = T, warning = F, comment = F>>=
...
<<Doorspread5, results = 'asis', echo = F, warning = F, fig.align = 'center'>>=
...
<<Residualcheck, fig.width = 4, fig.height = 4, echo = F, fig.align = 'center',warning = F, comment = F>>=
...
<<Doorspread3, fig.width = 4, fig.height = 4, echo = F, fig.align = 'center',warning = F, comment = F>>=
...
<<AddingWeights, echo = F, warning = F, comment = F, fig.width = 4, fig.height = 4, fig.align= 'center'>>=
...
<<ZeroCheck, echo = F, fig.width = 12, fig.height = 8, fig.align = 'center'>>=
