...
<<DoorSpread, fig.width = 5, fig.height = 5, echo = F, warnings = F, fig.align = 'center'>>=
...
<<Doorspread4, results = 'asis', echo = T, warnings = F>>=
...
stargazer(m1, m2, m3, font.size  = 'small', align = T, 
	  title = 'gam output from model with and without covariates', 
	  table.placement = 'H')
