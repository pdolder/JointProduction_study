...
%% \includegraphics[height=3cm, angle = -90]{"Paul_Dolder"} \hspace{0.1cm}
\includegraphics[height=3cm]{"Jim_Thorson"} \\
\vspace{1cm}
\includegraphics[width = 4cm]{seedcorn_logo_white_navy_bkgd} 
\hspace{0.5cm}
\includegraphics[width = 4cm]{MARES} 
\hspace{0.5cm}
\includegraphics[width = 4cm]{ichec_logo} 
