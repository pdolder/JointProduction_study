...
\end{subfigure}
\caption{Left: Factor 1 values for average spatial encounter probability
	correlated against; Left - Depth, Right - substrate type}
...
\end{subfigure}
\caption{Left: Factor 1 values for average spatial positive density correlated
...
\begin{center}
	...
	\label{fig:S5}
	\caption{Spatial loadings factor values for first three factors every
		five years for spatio-temporal encounter probability}
	\end{center}
\end{figure}
...
\begin{center}
	...
	\label{fig:S7}
	\caption{Spatial Loadings factor values for first three factors every
		five years for spatio-temporal density}
	\end{center}
\end{figure}
...
\begin{center}
	...
	\caption{Association of temperature and knots (individual lines; top)
		with Spatio-temporal factor loading values for encounter probability
...
\begin{center}
	...
	\label{fig:S11}
	\caption{Fixed effect estimates for surveys for each species. Note all
		values within a species are relative to the CEXP survey}
	\end{center}
\end{figure}
