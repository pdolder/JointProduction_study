...
counted against the respective stock quota. 
 ...
 Individual fishers goals are to maximise utility; whether that be profit, income or the
...
mesh to lift benthic flatfish species from the
...
factor loadings above, with roundfish (cod, haddock, whiting) , flatfish
(plaice and sole)  and species found in the deeper waters (hake, megrim and both
anglerfish species)  showing strong intra-group correlations indicating
