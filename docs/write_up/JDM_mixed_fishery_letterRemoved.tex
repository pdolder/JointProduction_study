...
are also positively associated with the third factor in the north while
...
\subsection{Time varying species distributions, but stability
		within species groups}   Inter-annual differences in factor
...
similar spatial distributions.    Correlation coefficients
for the average positive density also have strong associations among
 roundfish
(Figure 3b) 
