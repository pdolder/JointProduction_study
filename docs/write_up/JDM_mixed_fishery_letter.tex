...
subtle differences within species-groups. \deleted{The results highlight both
...
\cite{Mcclanahan2015} and \deleted{there} remains a need to ensure fisheries
...
\deleted{Societal objectives for fisheries to achieve MSY across ecosystem
	components are paralleled by} Individual fishers goals to maximise
...
likely\deleted{, however, that} this analysis reflects a lower bound on the
