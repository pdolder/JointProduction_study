...
l2 <- ggplot() + geom_text(aes(0.95,1), label = "encounter", size = 10) + theme_void()+ 
	xlim(0.9,1.1) + ylim(0.9,1.1)

l3 <- ggplot() + geom_text(aes(1.06,1), label = "(b) average", size = 10) + theme_void()+ 
	xlim(0.9,1.1) + ylim(0.9,1.1)

l4 <- ggplot() + geom_text(aes(0.95,1), label = "density", size = 10) + theme_void()+ 
	xlim(0.9,1.1) + ylim(0.9,1.1)
...
save_plot("../figures/Fig1_Combined.png", comb_plot, ncol = 5, nrow = 3)
