...
tools which simplify the complexities of mixed fisheries to help \replaced{avoid discarding}{managers and fishers maximise catches}. 
...
\subsection{\replaced{Time-varying species distributions, but stability within
		species groups}{Changes in spatial patterns over time, but
		stability in species dynamics}} While there are clear spatial
