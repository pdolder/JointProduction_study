...
quota \cite{Batsleer2015}. Therefore there is a pressing need for scientific
...
Societal objectives for fisheries are to achieve MSY across ecosystem
components are framed alongside individual fishers goals to maximise utility;
...
in implementing the landing obligation.  However, it likely the analysis
...
\begin{addendum}
 \item [Acknowledgements] Paul J Dolder gratefully acknowledges funding support
	 ...
	 The manuscript benefited hugely from discussions with David Stokes,
	 ...
	 Earl (Cefas).  Grateful thanks also go to Lisa Readdy for provision of
	 the Cefas datasets.
