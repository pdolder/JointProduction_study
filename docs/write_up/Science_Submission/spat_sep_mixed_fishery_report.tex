...
dynamics in space and time\deleted{\cite{Branch2008, Dunn2014a}}. 
%% General problem
...
\deleted{The results highlight both opportunities for and limitations of the
	ability to spatiotemporally separate catches.}
%%  general context
...
commercial species (see Table S2, Fig. 2) \deleted{: Atlantic cod
