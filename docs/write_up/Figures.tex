...
\begin{center}
	...
	\label{fig:1}
	\caption{Spatial factor coefficients illustrating the three main separating components for: (a) the average spatial encounter
		probability and (b) the average density . Scale goes from red (positive association to the factor) to white (no association) to blue (negative association)}
\end{center}
\end{figure}
